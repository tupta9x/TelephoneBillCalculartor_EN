...
class AppTest {
	...
	void wrongPhoneFormat() {
		TelephoneBillCalculator calculatorImp = new CalculatorImp();
		String logs = "" 
				+ "42077656235,18-01-2020 08:10:00\n";
		BigDecimal result = calculatorImp.calculate(logs);
		BigDecimal expectValue = BigDecimal.valueOf(0);
		assertEquals(expectValue, result);
	}
	...
	void outDateFormat() {
		TelephoneBillCalculator calculatorImp = new CalculatorImp();
		String logs = "" 
				+ "420776562354,420776562354,18-01-2020 08:10:00,18-01-2020 08:10:00\n";
		BigDecimal result = calculatorImp.calculate(logs);
		BigDecimal expectValue = BigDecimal.valueOf(0);
		assertEquals(expectValue, result);
	}	
	...
	void breakRule() {
		TelephoneBillCalculator calculatorImp = new CalculatorImp();
		String logs = "" 
				+ "4207765 62354,00,18-01-2020 08:10:00,18-01-2020 08:10:00\n";
		BigDecimal result = calculatorImp.calculate(logs);
		BigDecimal expectValue = BigDecimal.valueOf(0);
		assertEquals(expectValue, result);
	}
	...
	void sameTriplicate() {
		...
		BigDecimal result = calculatorImp.calculate(logs);
		BigDecimal expectValue = BigDecimal.valueOf(13.2); // not complete
		assertEquals(expectValue, result);
	}
